...
public class Explore1 : MonoBehaviour
{
    #region Enums
    ...
    private ComponentType currentComponentType = ComponentType.PowerSupply;
    ...
    {
        toastMessages = new string[4];
        toastMessages[(int)ToastMessageType.ScanMarker] = "Scan the Marker to get started with Activity";
        toastMessages[(int)ToastMessageType.PlacePowerSupply] = "Connect the Power Supply near the Arduino";
        toastMessages[(int)ToastMessageType.PlaceSelectedFirst] = "First you need to connect the Power Supply";
        toastMessages[(int)ToastMessageType.Success] = "Good Job! You have connected the Power Supply successfully. Next start with coding.";
    }
    ...
    public void OnMarkerFound()
    {
        ...
        {
            activeToastMessage = ToastMessageType.PlacePowerSupply;
        }
    ...
    public void OnTriggerEnter()
    {
        ...
        Debug.Log("Triggered ID: " + triggeredId);
        ...
        // Update toast - single component: go straight to success
        toastMsg.text = toastMessages[(int)ToastMessageType.Success];
        RestartToastCoroutine();
        activeToastMessage = ToastMessageType.Success;
    }
    ...
    {
        toastMsg.text = "Select the Power Supply from the component panel";
    }
    ...
    private void ShowPlacementHint()
    {
        ...
        {
            toastMsg.text = "Connect the Power Supply to the Arduino";
        }
    }
